...
|---|------|-------|------|-------|--------|------|
| T1 | Project scaffolding | dev | - | - | PENDING | A |
| T2 | Storage layer | dev | - | - | PENDING | A |
| T3 | Component renderers + CSS | dev | - | - | PENDING | A |
| T4 | HTML builder | dev | - | - | PENDING | B |
| T5 | Screenshot module | dev | - | - | PENDING | B |
| T6 | MCP server + tool schemas | dev | - | - | PENDING | B |
| T7 | Tool handlers (4 files) | dev | - | - | PENDING | C |
| T8 | Preview server | dev | - | - | PENDING | C |
| T9 | Entry point + wiring | dev | - | - | PENDING | D |
| T10 | Docker build + E2E test | dev | - | - | PENDING | D |
